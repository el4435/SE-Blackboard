"""Collect Day 10 experiment results into a CSV file.
...
Usage:
    python experiments/collect_day10_results.py
    python experiments/collect_day10_results.py --output data/analysis/day10_results.csv
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect Day 10 results to CSV")
    parser.add_argument(
        "--output", type=str,
        default="data/analysis/day10_results.csv",
