"""Day 10 Analysis: Fallback Apply + Whole-File Rewrite experiments.

Reads the CSV produced by collect_day10_results.py and generates:
...
Usage:
    python experiments/analyze_day10.py
    python experiments/analyze_day10.py --csv data/analysis/day10_results.csv
    python experiments/analyze_day10.py --save data/analysis/day10_analysis.json
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Day 10 experiment analysis")
    parser.add_argument(
...
def main() -> None:
    ...
    if not csv_path.exists():
        ...
        console.print("Run `python experiments/collect_day10_results.py` first.")
        return

    rows = load_csv(csv_path)
    console.rule("[bold blue]Day 10 Experiment Analysis[/bold blue]")
